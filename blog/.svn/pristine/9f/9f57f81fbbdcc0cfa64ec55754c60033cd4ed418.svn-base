...
class HTMLPurifier_ElementDef
{
    ...
    /**
     * Article of tags HTMLPurifier_AttrTransform to be done before validation.
     * @type array
     */
    public $attr_transform_pre = array();

    /**
     * Article of tags HTMLPurifier_AttrTransform to be done after validation.
     * @type array
     */
    ...
    /**
     * Article of the names of required attributes this element has.
