...
class HTMLPurifier_HTMLModule
{
    ...
    /**
     * Article of HTMLPurifier_AttrTransform to be performed before validation.
     * @type array
     */
    public $info_attr_transform_pre = array();

    /**
     * Article of HTMLPurifier_AttrTransform to be performed after validation.
     * @type array
     */
    public $info_attr_transform_post = array();

    /**
     * Article of HTMLPurifier_Injector to be performed during well-formedness fixing.
     ...
     * true as value.
     * @param string $list Article of values to turn into a lookup
