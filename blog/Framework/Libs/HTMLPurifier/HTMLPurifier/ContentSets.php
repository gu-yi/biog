...
class HTMLPurifier_ContentSets
{
    ...
    /**
     * Article of content set strings (pipe separators) indexed by name.
     * @type array
     */
    public $info = array();

    /**
     * Article of content set lookups (element => true) indexed by name.
     * @type array
     ...
     * @param HTMLPurifier_HTMLModule[] $modules Article of HTMLPurifier_HTMLModule
     */
     ...
     * a lookup array.
     * @param string $string Article of elements
